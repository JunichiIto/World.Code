...
class SubmitsControllerTest < ActionController::TestCase
  ...
  test "should create submit" do
    assert_difference('Submit.count') do
      post :create, submit: { description: @submit.description, language: @submit.language, source: @submit.source }
    end
  ...
  test "should update submit" do
    patch :update, id: @submit, submit: { description: @submit.description, language: @submit.language, source: @submit.source }
    assert_redirected_to submit_path(assigns(:submit))
  end
